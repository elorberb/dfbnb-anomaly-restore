...
class DFBnB:
    ...
    def _print_verbose_output(self, current_path, current_node, current_cost):
        ...
        logger.info(f'PATH: {current_path}, Curr_Node: {current_node}, Cost: {current_cost}, Bound: {self.bound}')
    ...
    def print_search_results(self):
        ...
        logger.info("-------------------------------------------------------------------------------")
        logger.info(f"Best Path: {'-> '.join(map(str, self.optimal_path))}, with the Cost: {self.bound}")
        logger.info(f"Nodes Expanded: {', '.join(map(str, self.expanded_nodes))}")
        logger.info("-------------------------------------------------------------------------------")
